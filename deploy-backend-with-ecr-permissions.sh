#!/bin/bash
# 🔧 FIXED: EC2 now has ECR permissions!
# Wait 10 seconds for IAM permissions to propagate, then run this script in EC2 Instance Connect
...
# Login to ECR (should work now with new permissions)
