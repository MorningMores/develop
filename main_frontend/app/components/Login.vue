...
const handleSubmit = async () => {
  ...
  // // ===================================================================
  // // --- FAKE LOGIN FOR TESTING (Bypasses the real API call) ---
  // // ===================================================================

  // // 1. Simulate a network delay
  // await new Promise(resolve => setTimeout(resolve, 500));

  // // 2. Create a fake successful response object
  // const fakeResponse = {
  //   token: 'fake-jwt-token-for-testing-purposes',
  //   email: email.value,
  //   username: email.value.split('@')[0] || 'TestUser'
  // };

  // // 3. Show a success message
  // message.value = `(TEST MODE) Login successful! Welcome back ${fakeResponse.username}!`;
  // isSuccess.value = true;

  // // 4. Save the fake authentication data to storage
  // if (process.client) {
  //   saveAuth({ token: fakeResponse.token, email: fakeResponse.email, username: fakeResponse.username }, rememberMe.value)
  // }
  
  // // 5. Stop the loading indicator
  // isLoading.value = false;

  // // 6. Redirect to the home page after a short delay
  // await navigateTo('/')

  // ===================================================================
  // --- ORIGINAL API LOGIN LOGIC (COMMENTED OUT FOR TESTING) ---
  // ===================================================================
