    ...
    <div v-else class="container mx-auto px-4 py-8 max-w-7xl">
      <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 lg:p-12">
          ...
          <!-- Left column now focuses on event information -->
          <div class="space-y-6">
            <div class="flex items-center gap-2">
              <span
                v-if="event.category"
                class="px-3 py-1 bg-violet-100 text-violet-700 text-sm font-semibold rounded-full"
              >
                {{ event.category }}
              </span>
              <span
          ...
          <div class="flex flex-col justify-between space-y-8">
            <div class="space-y-6">
              ...
              <div v-else-if="actualAvailableSeats < 10" class="flex items-center gap-3">
                ...
                <span class="text-orange-600 font-semibold">
                  Only {{ actualAvailableSeats }} seat{{ actualAvailableSeats !== 1 ? 's' : '' }} left!
                </span>
              </div>
              ...
              <div class="bg-violet-50 rounded-xl p-4 space-y-2">
                ...
                <p v-if="isEventFull" class="text-sm font-semibold text-red-600">🚫 Event is full</p>
            ...
            <!-- Booking and participants section (unchanged) -->
            <div class="space-y-6">
              <div v-if="!isEventFull" class="space-y-2">
                ...
                <div class="flex items-center gap-4">
                  <div class="flex items-center border-2 border-gray-300 rounded-lg bg-white shadow-sm">
                    <button
                      type="button"
                      class="px-6 py-3 bg-gray-100 hover:bg-gray-200 active:bg-gray-300 transition-colors font-bold text-xl"
                    ...
                    <input
                      ...
                      class="w-20 text-center py-3 font-semibold text-lg border-0 focus:outline-none"
                    />
                    <button
                      type="button"
                      class="px-6 py-3 bg-gray-100 hover:bg-gray-200 active:bg-gray-300 transition-colors font-bold text-xl"
