    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-slate-800/50 backdrop-blur-xl border border-purple-500/20 rounded-2xl shadow-lg shadow-purple-500/20 p-6 md:p-8 mb-8">
        <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
          <!-- Profile Avatar -->
          <div class="relative">
            <div class="w-24 h-24 bg-gradient-to-br from-purple-500 to-pink-600 rounded-full flex items-center justify-center text-white text-3xl font-bold shadow-lg shadow-purple-500/50">
              {{ userInitials }}
            </div>
            <button class="absolute bottom-0 right-0 bg-purple-900/50 backdrop-blur-sm border border-purple-500/30 rounded-full p-2 shadow-md hover:shadow-lg transition-shadow">
              📷
            </button>
          </div>
