  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900">
          ...
          <div class="relative h-[500px] sm:h-[600px]">
            ...
            <transition-group name="slide">
              ...
              >
                ...
                >
                  <!-- Cosmic Icon -->
                  <div class="absolute top-10 right-10 text-8xl opacity-20 animate-float">
                    {{ slide.image }}
                  </div>

                  <div class="text-center text-white px-6 max-w-4xl z-10">
                    <div class="text-6xl mb-6 animate-bounce-slow">{{ slide.image }}</div>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div class="text-center mb-12">
        <h2 class="text-4xl sm:text-5xl font-bold text-white mb-4 bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent">
