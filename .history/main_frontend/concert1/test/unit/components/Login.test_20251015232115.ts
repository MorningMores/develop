...
describe('Login Component', () => {
  ...
  it('should load saved email from localStorage when remember me is true', () => {
  ...
  it('should not load email when remember me is false', () => {
  ...
  it('should handle missing saved email even when remember me is true', () => {
    localStorage.setItem('remember_me', 'true')
  ...
  it('should display success message with green background', async () => {
    ...
    expect(messageDiv.text()).toContain('Login successful')
  })
