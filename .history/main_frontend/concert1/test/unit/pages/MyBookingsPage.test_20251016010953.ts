...
describe('MyBookingsPage.vue', () => {
  ...
  // fetchBookings - empty bookings message
  it('should set message when bookings array is empty', async () => {
    ;(global.$fetch as any).mockResolvedValueOnce([])
    ...
    expect(wrapper.vm.message).toBe('You have no bookings yet.')
  })

  // fetchBookings - error with data.message
  it('should handle error with data.message in fetchBookings', async () => {
    ;(global.$fetch as any).mockRejectedValueOnce({
    ...
    expect(wrapper.vm.message).toContain('Custom error message')
  })

  // fetchBookings - error without message (default)
  it('should use default error message when error has no message', async () => {
    ...
    expect(wrapper.vm.message).toBe('Failed to load your bookings.')
  })
