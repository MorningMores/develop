...
-- Create events table with category field for Music, Sports, Tech, Art, Food, Business, Other
CREATE TABLE events (
    event_id BIGINT AUTO_INCREMENT PRIMARY KEY,
    title VARCHAR(200) NOT NULL,
    category VARCHAR(100) COMMENT 'Event category: Music, Sports, Tech, Art, Food, Business, Other',
    description TEXT,
...
-- Note: event_id is BIGINT because events can be in both MySQL and JSON file
...
('Tech Conference 2025', 'Tech', 'Latest trends in technology and innovation', 'Convention Center, San Francisco', '2025-06-20 09:00:00', '2025-06-22 18:00:00', 2),
...
('Comedy Night', 'Other', 'Stand-up comedy show with famous comedians', 'Comedy Club, Los Angeles', '2025-09-15 20:00:00', '2025-09-15 23:00:00', 5),
('Basketball Championship', 'Sports', 'Professional basketball tournament', 'Madison Square Garden, New York', '2025-10-20 19:00:00', '2025-10-20 22:00:00', 6),
('Business Summit 2025', 'Business', 'Networking and business development conference', 'Hilton Hotel, Chicago', '2025-11-05 08:00:00', '2025-11-06 18:00:00', 7);
...
(6, 'General', 50.00, 500),
(6, 'VIP', 120.00, 100),
(7, 'Standard', 299.00, 300),
(7, 'Premium', 499.00, 100);

-- Display success message
SELECT 'Database setup completed successfully!' as status;
SELECT 'Default password for all users is: password123' as note;
SELECT 'Event categories available: Music, Sports, Tech, Art, Food, Business, Other' as categories;

-- Create MySQL user for the application
CREATE USER IF NOT EXISTS 'concert_user'@'%' IDENTIFIED BY 'concert_password';
...
SELECT 'MySQL users created: concert_user/concert_password and username/password' as user_info;
